...
if &background == "dark"
    ...
    if s:xmoria_monochrome == 1
        Hi FoldColumn guibg=NONE guifg=#a0a0a0 gui=none
        Hi CursorLineNr guifg=#a0a0a0 gui=bold
        Hi LineNr guifg=#a0a0a0 gui=none
        Hi MoreMsg guibg=NONE guifg=#b6b6b6 gui=bold
        Hi NonText guibg=NONE guifg=#a0a0a0 gui=bold
        Hi Pmenu guibg=#909090 guifg=#000000 gui=none
        Hi PmenuSbar guibg=#707070 guifg=NONE gui=none
        Hi PmenuThumb guibg=#d0d0d0 guifg=bg gui=none
        Hi SignColumn guibg=NONE guifg=#a0a0a0 gui=none
        Hi StatusLine guibg=#4c4c4c guifg=NONE gui=bold
        Hi StatusLineNC guibg=#404040 guifg=NONE gui=none
        Hi TabLine guibg=#6e6e6e guifg=NONE gui=none
        Hi TabLineFill guibg=#6e6e6e guifg=NONE gui=none
        Hi VertSplit guibg=#404040 guifg=NONE gui=none
        ...
        Hi FoldColumn guibg=NONE guifg=#8fa5d1 gui=none
        Hi CursorLineNr guifg=#8fa5d1 guibg=#404040 gui=bold
        Hi LineNr guifg=#7284a7 guibg=#2a2a2a gui=none
        Hi MoreMsg guibg=NONE guifg=#97abd5 gui=bold
        Hi NonText guibg=NONE guifg=#8fa5d1 gui=bold
        Hi Pmenu guibg=#6381be guifg=#000000 gui=none
        Hi PmenuSbar guibg=#41609e guifg=NONE gui=none
        Hi PmenuThumb guibg=#bdcae3 guifg=bg gui=none
        Hi SignColumn guibg=#2a2a2a guifg=#8fa5d1 gui=none
        Hi StatusLine guibg=#334b7d guifg=NONE gui=bold
        Hi StatusLineNC guibg=#25365a guifg=NONE gui=none
        Hi TabLine guibg=#334b7d guifg=NONE gui=none
        Hi TabLineFill guibg=#334b7d guifg=NONE gui=none
        Hi VertSplit guibg=#25365a guifg=NONE gui=none
        if s:xmoria_fontface == "mixed"
    ...
    Hi Cursor guibg=#ffa500 guifg=NONE gui=none
    Hi DiffAdd guibg=#008b00 guifg=NONE gui=none
    Hi DiffChange guibg=#00008b guifg=NONE gui=none
    Hi DiffDelete guibg=#8b0000 guifg=NONE gui=none
    Hi DiffText guibg=#0000cd guifg=NONE gui=bold
    Hi Directory guibg=NONE guifg=#1e90ff gui=none
    ...
    Hi Question guibg=NONE guifg=#e8b87e gui=bold
    Hi Search guibg=#90e090 guifg=#000000 gui=none
    Hi SpecialKey guibg=NONE guifg=#e8b87e gui=none
    if has("nvim")
    ...
    if version >= 700
        ...
        Hi Visual guibg=#606060 guifg=NONE gui=none
    endif
    Hi VisualNOS guibg=NONE guifg=#a0a0a0 gui=bold,underline
    Hi WarningMsg guibg=NONE guifg=#ee2c2c gui=bold
    Hi WildMenu guibg=#e0e000 guifg=#000000 gui=bold

    Hi Comment guibg=NONE guifg=#d0d0a0 gui=none
    Hi Constant guibg=NONE guifg=#87df71 gui=none
    Hi Error guibg=NONE guifg=#ee2c2c gui=none
    Hi Identifier guibg=NONE guifg=#7ee0ce gui=none
    Hi Ignore guibg=NONE guifg=bg gui=none
    Hi lCursor guibg=#00e700 guifg=#000000 gui=none
    Hi MatchParen guibg=#008b8b gui=none
    Hi PreProc guibg=NONE guifg=#d7a0d7 gui=none
    Hi Special guibg=NONE guifg=#e8b87e gui=none
    Hi Todo guibg=#e0e000 guifg=#000000 gui=none
    Hi Underlined guibg=NONE guifg=#00a0ff gui=underline

    if s:xmoria_fontface == "mixed"
        Hi Statement guibg=NONE guifg=#7ec0ee gui=bold
        Hi Type guibg=NONE guifg=#f09479 gui=bold
    else
        Hi Statement guibg=NONE guifg=#7ec0ee gui=none
        Hi Type guibg=NONE guifg=#f09479 gui=none
    endif
elseif &background == "light"
    ...
    if s:xmoria_monochrome == 1
        Hi FoldColumn guibg=NONE guifg=#7a7a7a gui=none
        Hi Folded guibg=#cfcfcf guifg=#404040 gui=bold
        Hi CursorLineNr guifg=#7a7a7a gui=bold
        Hi LineNr guifg=#7a7a7a gui=none
        Hi MoreMsg guibg=NONE guifg=#505050 gui=bold
        Hi NonText guibg=NONE guifg=#7a7a7a gui=bold
        Hi Pmenu guibg=#9a9a9a guifg=#000000 gui=none
        Hi PmenuSbar guibg=#808080 guifg=NONE gui=none
        Hi PmenuThumb guibg=#c0c0c0 guifg=NONE gui=none
        Hi SignColumn guibg=NONE guifg=#7a7a7a gui=none
        Hi StatusLine guibg=#a0a0a0 guifg=NONE gui=bold
        Hi StatusLineNC guibg=#b0b0b0 guifg=NONE gui=none
        Hi TabLine guibg=#cdcdcd guifg=NONE gui=none
        Hi TabLineFill guibg=#cdcdcd guifg=NONE gui=none
        Hi VertSplit guibg=#b0b0b0 guifg=NONE gui=none
    else
        Hi FoldColumn guibg=NONE guifg=#375288 gui=none
        Hi Folded guibg=#cfcfcf guifg=#25365a gui=bold
        Hi CursorLineNr guifg=#375288 gui=bold
        Hi LineNr guifg=#375288 gui=none
        Hi MoreMsg guibg=NONE guifg=#2f4471 gui=bold
        Hi NonText guibg=NONE guifg=#375288 gui=bold
        Hi Pmenu guibg=#708bc5 guifg=#000000 gui=none
        Hi PmenuSbar guibg=#4a6db5 guifg=NONE gui=none
        Hi PmenuThumb guibg=#a6b7db guifg=NONE gui=none
        Hi SignColumn guibg=NONE guifg=#375288 gui=none
        Hi StatusLine guibg=#8fa5d1 guifg=NONE gui=bold
        Hi StatusLineNC guibg=#a6b7db guifg=NONE gui=none
        Hi TabLine guibg=#b8c6e2 guifg=NONE gui=none
        Hi TabLineFill guibg=#b8c6e2 guifg=NONE gui=none
        Hi VertSplit guibg=#a6b7db guifg=NONE gui=none
    endif
    ...
    Hi Directory guibg=NONE guifg=#0000f0 gui=none
    Hi ErrorMsg guibg=#ee2c2c guifg=#ffffff gui=bold
    Hi IncSearch guibg=#ffcd78 gui=none
    Hi ModeMsg guibg=NONE guifg=NONE gui=bold
    Hi PmenuSel guibg=#ffff00 guifg=#000000 gui=none
    Hi Question guibg=NONE guifg=#813f11 gui=bold
    Hi Search guibg=#a0f0a0 gui=none
    Hi SpecialKey guibg=NONE guifg=#912f11 gui=none
    if has("spell")
        Hi SpellBad guisp=#ee2c2c gui=undercurl
        Hi SpellCap guisp=#2c2cee gui=undercurl
    ...
    if version >= 700
        ...
        Hi Visual guibg=#c4c4c4 guifg=NONE gui=none
    endif
    Hi VisualNOS guibg=NONE guifg=#a0a0a0 gui=bold,underline
    Hi WarningMsg guibg=NONE guifg=#ee2c2c gui=bold
    Hi WildMenu guibg=#ffff00 guifg=NONE gui=bold

    Hi Comment guibg=NONE guifg=#786000 gui=none
    Hi Constant guibg=NONE guifg=#077807 gui=none
    Hi Error guibg=NONE guifg=#ee2c2c gui=none
    Hi Identifier guibg=NONE guifg=#007080 gui=none
    Hi Ignore guibg=NONE guifg=bg gui=none
    Hi lCursor guibg=#008000 guifg=#ffffff gui=none
    Hi MatchParen guibg=#00ffff gui=none
    Hi PreProc guibg=NONE guifg=#800090 gui=none
    Hi Special guibg=NONE guifg=#912f11 gui=none
    Hi Statement guibg=NONE guifg=#1f3f81 gui=bold
    Hi Todo guibg=#ffff00 guifg=NONE gui=none
    Hi Type guibg=NONE guifg=#912f11 gui=bold
    Hi Underlined guibg=NONE guifg=#0000cd gui=underline
endif
